...
namespace Secubd.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.Email,Email=model.Email, nomEns = model.nomEns, grade = model.grade, prenomEns = model.prenomEns, anneePriseFonction = model.anneePriseFonction };
